defmodule PortfolioWeb.PhotographyLive.ModalContent do
  ...
  Contains all chapter-specific text content, extracted from the main
  PhotographyLive.Index module for better maintainability.
  """
  ...
  def chapter_modal(assigns) do
    ...
    <div class={[
      ...
      <div class="space-y-4">
        <.chapter_content chapter={@modal_chapter} />
      </div>
  ...
  def chapter_content(%{chapter: "amvcc"} = assigns) do
    ~H"""
    <p>
      {gettext(
  ...
  def chapter_content(%{chapter: "landscape"} = assigns) do
    ~H"""
    <p>
      {gettext(
  ...
  def chapter_content(%{chapter: "music"} = assigns) do
    ~H"""
    <p>
      {gettext(
  ...
  def chapter_content(%{chapter: "reenactment"} = assigns) do
    ~H"""
    <p>
      {gettext(
  ...
  def chapter_content(%{chapter: "street"} = assigns) do
    ~H"""
    <p>
      {gettext(
  ...
  def chapter_content(%{chapter: "china"} = assigns) do
    ~H"""
    <p>
      {gettext(
  ...
  def chapter_content(%{chapter: "japan"} = assigns) do
    ~H"""
    <p>
      {gettext(
  ...
  def chapter_content(%{chapter: "taiwan"} = assigns) do
    ~H"""
    <p>
      {gettext(
  ...
  def chapter_content(%{chapter: "couples"} = assigns) do
    ~H"""
    <p>
      {gettext(
  ...
  def chapter_content(%{chapter: "motherhood"} = assigns) do
    ~H"""
    <p>
      {gettext(
  ...
  def chapter_content(%{chapter: "wedding"} = assigns) do
    ~H"""
    <p>
      {gettext(

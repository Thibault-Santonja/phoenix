defmodule PortfolioWeb.PhotographyLive.ChapterContent do
  @moduledoc """
  Static content for photography chapter modals.

  Contains all chapter-specific text content, separated from the modal
  rendering logic for better maintainability and reduced file size.
  """

  use PortfolioWeb, :html

  attr :chapter, :string, required: true

  def render(%{chapter: "amvcc"} = assigns) do
    ~H"""
    <p>
      {gettext(
  ...
  def render(%{chapter: "landscape"} = assigns) do
    ~H"""
    <p>
      {gettext(
  ...
  def render(%{chapter: "music"} = assigns) do
    ~H"""
    <p>
      {gettext(
  ...
  def render(%{chapter: "reenactment"} = assigns) do
    ~H"""
    <p>
      {gettext(
  ...
  def render(%{chapter: "street"} = assigns) do
    ~H"""
    <p>
      {gettext(
  ...
  def render(%{chapter: "china"} = assigns) do
    ~H"""
    <p>
      {gettext(
  ...
  def render(%{chapter: "japan"} = assigns) do
    ~H"""
    <p>
      {gettext(
  ...
  def render(%{chapter: "taiwan"} = assigns) do
    ~H"""
    <p>
      {gettext(
  ...
  def render(%{chapter: "couples"} = assigns) do
    ~H"""
    <p>
      {gettext(
  ...
  def render(%{chapter: "motherhood"} = assigns) do
    ~H"""
    <p>
      {gettext(
  ...
  def render(%{chapter: "wedding"} = assigns) do
    ~H"""
    <p>
      {gettext(
  ...
  def render(%{chapter: "events"} = assigns) do
    ~H"""
    <p>
      {gettext(
        "Events are unique moments where people come together to celebrate, learn, or create. As a photographer, I capture the energy, the connections, and the atmosphere that make each gathering special."
      )}
    </p>
    """
  end

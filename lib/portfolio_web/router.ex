defmodule PortfolioWeb.Router do
  ...
  scope "/", PortfolioWeb do
    ...
    ash_authentication_live_session :authenticated_routes do
      ...
      # on_mount {PortfolioWeb.LiveUserAuth, :live_user_required}
      #
      # If an authenticated user *may* be present:
      # on_mount {PortfolioWeb.LiveUserAuth, :live_user_optional}
      #
      # If an authenticated user must *not* be present:
      # on_mount {PortfolioWeb.LiveUserAuth, :live_no_user}
    end
  end
  ...
  scope "/", PortfolioWeb do
    ...
    auth_routes AuthController, Portfolio.Accounts.User, path: "/auth"
    ...
    confirm_route Portfolio.Accounts.User, :confirm_new_user,
      auth_routes_prefix: "/auth",
      overrides: [PortfolioWeb.AuthOverrides, AshAuthentication.Phoenix.Overrides.Default]

    # Remove this if you do not use the magic link strategy.
    magic_sign_in_route(Portfolio.Accounts.User, :magic_link,
      auth_routes_prefix: "/auth",
      overrides: [PortfolioWeb.AuthOverrides, AshAuthentication.Phoenix.Overrides.Default]
    )
  end

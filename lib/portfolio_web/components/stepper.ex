defmodule PortfolioWeb.Components.Stepper do
  @moduledoc """
  The `PortfolioWeb.Components.Stepper` module provides a flexible and interactive stepper component
  ...
  The `PortfolioWeb.Components.Stepper` enhances user experience by providing a clear and concise representation

defmodule PortfolioWeb.FormComponents do
  @moduledoc """
  Form-related UI components.

  This module provides reusable form components including inputs, labels,
  buttons, and form wrappers. All components are styled with Tailwind CSS.
  """

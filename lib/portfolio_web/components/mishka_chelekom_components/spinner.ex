defmodule PortfolioWeb.Components.Spinner do
  @moduledoc """
  The `PortfolioWeb.Components.Spinner` module provides a dynamic and customizable loading spinner
  ...
  With its flexible design, the `PortfolioWeb.Components.Spinner` module enables developers to provide
  ...
  defp spinner_content(%{type: "pinging"} = assigns) do
    ~H"""
    <span class="sr-only">{gettext("mishka.spinner.loading")}</span>

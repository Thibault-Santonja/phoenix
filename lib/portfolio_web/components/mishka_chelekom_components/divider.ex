defmodule PortfolioWeb.Components.Divider do
  @moduledoc """
  The `PortfolioWeb.Components.Divider` module provides a versatile and customizable divider
  ...
  @doc """
  `PortfolioWeb.Components.Divider.hr` is used to create a horizontal divider with customizable style, color,
  and size options.

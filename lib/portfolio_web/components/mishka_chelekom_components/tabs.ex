defmodule PortfolioWeb.Components.Tabs do
  @moduledoc """
  `PortfolioWeb.Components.Tabs` is a Phoenix component module that provides a highly customizable tab
  ...
  import PortfolioWeb.Components.Badge, only: [badge: 1]

defmodule PortfolioWeb.Components.Chat do
  @moduledoc """
  `PortfolioWeb.Components.Chat` is a Phoenix LiveView component module for creating customizable chat interfaces.

defmodule PortfolioWeb.Components.ScrollArea do
  @moduledoc """
  The `PortfolioWeb.Components.ScrollArea` module provides a customizable scroll area component for Phoenix LiveView

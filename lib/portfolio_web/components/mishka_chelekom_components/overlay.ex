defmodule PortfolioWeb.Components.Overlay do
  @moduledoc """
  The `PortfolioWeb.Components.Overlay` module provides a versatile overlay component for
  ...
  The `PortfolioWeb.Components.Overlay` is perfect for creating modal backgrounds, loading screens,

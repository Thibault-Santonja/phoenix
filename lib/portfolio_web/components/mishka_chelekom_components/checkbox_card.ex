defmodule PortfolioWeb.Components.CheckboxCard do
  @moduledoc """
  The `PortfolioWeb.Components.CheckboxCard` module provides a customizable checkbox card component for Phoenix LiveView

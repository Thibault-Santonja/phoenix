defmodule PortfolioWeb.Components.Menu do
  @moduledoc """
  The `PortfolioWeb.Components.Menu` module is designed to render a hierarchical menu structure in
  ...
  The `PortfolioWeb.Components.Menu` is ideal for creating multi-level navigation menus in
  ...
  import PortfolioWeb.Components.Accordion, only: [accordion: 1]
  import PortfolioWeb.Components.Button, only: [button_link: 1]
